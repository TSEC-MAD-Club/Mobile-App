String getCommitteeImageByName(String committeeName) {
  switch (committeeName) {
    ...
    case "RC-TSEC":
      return "https://firebasestorage.googleapis.com/v0/b/tsec-app.appspot.com/o/committees%2Ftsec_rotaract_club.png?alt=media&token=897ea97b-613f-4eab-94f7-bd402d3ad95a";

    case "TSEC Student Council":
      return "https://firebasestorage.googleapis.com/v0/b/tsec-app.appspot.com/o/committees%2Fstudent_council.jpg?alt=media&token=d2a6d762-70d7-49da-b5af-a66fbad4c344";
    ...
    case "GDSC-TSEC":
      return "https://firebasestorage.googleapis.com/v0/b/tsec-app.appspot.com/o/committees%2FGdsc%20tsec.png?alt=media&token=fa302825-cfa7-400d-b927-1ad5a0e07982";
    default:
