...
class _AnnouncementScreenState extends ConsumerState<AnnouncementScreen> {
        ...
        builder: (context, snapshot) {
          ...
          final announcements = announcementsData
            ...
            if (studentModel == null &&
                announcement.gradYear!.contains("All")) {
              return true;
            }
  ...
  Widget _buildDateHeader(DateTime date) {
    ...
    return Container(
      ...
      child: Text(
        "${date.toLocal()}"
            .split(' ')[0], // Display the date in a readable format
...
class AnnouncementListItem extends StatelessWidget {
  ...
  const AnnouncementListItem({super.key, required this.announcementModel});

  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    if (announcementModel.startDate == null ||
        announcementModel.endDate == null) {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    if (announcementModel.docURL != null &&
                        announcementModel.docURL != "")
                      InkWell(
                        splashFactory: NoSplash.splashFactory,
                        onTap: () => launchUrl(
                          Uri.parse(
                            announcementModel.docURL.toString(),
                          ),
                        ),
                        child: Icon(
                          Icons.link,
                ...
                if (announcementModel.content != null ||
                  ...
                  Text(
                    announcementModel.content.toString(),
                    style: TextStyle(color: Colors.white),
                  ),
                SizedBox(height: 5),
              ],
